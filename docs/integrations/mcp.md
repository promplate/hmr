...
Example: simple server structure (see [examples/mcp/](../../examples/mcp/))
...
- [Advanced Reactivity](../reactive/advanced.md) for recommended reactive patterns
- [MCP Example](../../examples/mcp/) for concrete usage examples with MCP Inspector and client demos
