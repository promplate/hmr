...
for artifact in cpu-smoke-receipt.json cpu-smoke-full.log cpu-source-manifest.json cpu-hmr-events cpu-runner-full.log cpu-container.cid cpu-container-receipt.json; do
